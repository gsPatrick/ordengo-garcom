    ...
    return (
        <div className="flex flex-col h-screen bg-white">
            <header className="flex items-center p-3 border-b sticky top-0 bg-white z-10">
                ...
                <h1 className="text-xl font-bold ml-4">Fechamento - Mesa {table.id}</h1>
            </header>

            <main className="flex-1 overflow-y-auto p-6 space-y-6">
                <section>
                    <h4 className="font-semibold mb-4 text-lg">Itens Consumidos</h4>
                ...
                <section className="space-y-2 text-md">
                    ...
                    <div className="flex justify-between text-gray-500"><span>Taxa de serviço (10%)</span><span>{formatCurrency(serviceFee)}</span></div>
